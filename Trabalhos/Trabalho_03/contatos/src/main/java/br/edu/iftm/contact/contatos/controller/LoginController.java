...
public class LoginController {
    ...
    // quando digitado "localgost/" será direcionado para a página de Login
    @RequestMapping("/")
    ...
    // Direciona para a tela de cadastro após o click no link novo usuário
    @RequestMapping("/login/telaNovoUsuario")
    public String novo(Model model) {
        return "cadastro";
    }

    // Cadastr concluído, retorna para página de login informando o usuário que deu certo
    ...
    // validações de login senha e roles
    ...
    // desconecta o ultimo usuário logado
